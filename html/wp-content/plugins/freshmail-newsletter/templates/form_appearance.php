...
<div class="tabs" id="appearance">
		...
		<p>
			...
			<input type="button" value="<?php _e('Save as custom theme', 'wp_freshmail'); ?>" class="freshmail_custom_submit freshmail_api_key_submit button button_fm" onclick="saveAsCustomTheme();" />
		</p>
		</div>
		<div class="fm-preview-theme">
			...
			<p><?php if (isset($_POST['theme_id'])):
				...
				<select id="freshmail_select_theme" name="fm_form_var[appearance][freshmail_select_theme]" onchange="changeTheme();">
